  ...
  return connect.router(function(app){
    ...
    app.get('/:project', function(req, res, next) {
      ...
      request({ uri: 'https://' + Path.join('raw.github.com', path)}, function(err, response, body) {
        ...
        var data = ghm.parse(body), layout, partial;
        
        partial = util.toHtml(tmplKey, {config: o, content: data, name: project});
        layout = util.toHtml('tmpl.layout.html', {context: {content: data, config: o}, content: partial});
